...
const Kontakt = ({ kontaktRef }) => {
  ...
  // Use kontaktRef for useInView
  const isInView = useInView(kontaktRef, { margin: "-100px" });
  ...
  return (
    <motion.div
      ...
      whileInView="animate"
    >
      <motion.div className="kontakt-textContainer" variants={variants}>
        <motion.h1 variants={variants}>Sodelujmo</motion.h1>
        <motion.div className="item" variants={variants}>
          <h2>Email</h2>
          <Link to="mailto:nejc.ropic@gmail.com">
            <span>nejc.ropic@gmail.com</span>
          </Link>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Zagradec 36A</h2>
          <span>1303 Zagradec</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Telefon</h2>
          <Link to="tel:+38640641152">
            <span>+386-40-641-152</span>
          </Link>
        </motion.div>
      </motion.div>
      <div className="kontakt-formContainer">
        <motion.div
          className="phoneSvg"
          initial={{ opacity: 1 }}
        ...
        >
          <svg width="300px" height="300px" viewBox="0 0 32.666 32.666">
           ...
           c-1.117-0.952-2.364-2.351-3.458-3.457c-0.028-0.029-0.062-0.061-0.092-0.092c-0.031-0.029-0.062-0.062-0.093-0.092
           ...
           c0.03,0.031,0.059,0.062,0.088,0.095c1.16,1.118,2.535,2.765,4.769,4.255c4.703,3.141,8.312,2.264,10.438,1.098
        ...
        >
          <input type="text" required placeholder="Ime" name="name" />
          <input type="email" required placeholder="Email" name="email" />
          <textarea rows={8} placeholder="Vsebina" name="message" />
